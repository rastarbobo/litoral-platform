/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example` (hash: b5c29cf72345f20fb5d137b198cf6ebc)
// Runtime types generated with workerd@1.20260617.1 2026-04-21 nodejs_compat
interface __BaseEnv_Env {
	NEXT_INC_CACHE_KV: KVNamespace;
	OPT_OUT_KV: KVNamespace;
	...
	N8N_WEBHOOK_REPLY_ALERT_URL: string;
	COMPETITOR_WEBHOOK_SECRET: string;
	TRACKING_WEBHOOK_SECRET: string;
	N8N_WEBHOOK_ANALYTICS_REPORT_URL: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker-entrypoint");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_TEST_MODE" | "EMAIL_FROM" | "EMAIL_FROM_NAME" | "EMAIL_REPLY_TO" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "STRIPE_SECRET_KEY" | "NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY">> {}
}
